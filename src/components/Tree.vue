  ...
  <div :class="wrapperCls">
    ...
    >
      ...
      <div :class="blockAreaCls">
        ...
        <VTreeNode
          v-for="node in expandAnimation.ready.value
            ? expandAnimation.topNodes.value
            : renderNodes"
...
const treeNodeListeners = TREE_NODE_EVENTS.reduce(
  (prev, eventName) => {
...
const getNodeClassName = (node: TreeNode) => {
  return typeof props.nodeClassName === 'function'
    ? props.nodeClassName(node)
    : props.nodeClassName
}
...
const sameValue = (
  newVal: VModelType,
  valueCache: VModelType | undefined
): boolean => {
